...
export const mainNavigation: NavItem[] = [
  ...
  },
  {
    ...
    megaMenu: [
      {
        label: "Edible & Gourmet Salts",
        to: "/edible-gourmet-salts",
        links: [],
      },
      {
      ...
      },
      {
        ...
        links: [
          ...
          {
            label: "Salt Bricks & Blocks",
            to: "/tiles-bricks-blocks/salt-bricks-blocks",
          },
        ],
      },
...
export const footerNavigation: NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Aromatherapy Salt Lamps", to: "/aromatherapy-salt-lamps" },
      {
        label: "Himalayan Salt Candle Holders",
        to: "/himalayan-salt-candle-holders",
      },
  ...
  },
  {
    label: "B2B & Trade",
    links: [
      { label: "Private Labeling", to: "/private-labeling" },
